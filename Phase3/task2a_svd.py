...
def get_similarity_matrix(matrix):
    file_path = __output_folder + '/similarity_svd.npz'
    if os.path.isfile(file_path):
        return scipy.sparse.load_npz(__output_folder + '/similarity_svd.npz')
    else:
        ...
        scipy.sparse.save_npz(__output_folder + '/similarity_svd.npz', c_mat)
        return sim
