...
def get_p_diff_1(genre1, genre2):
    ...
    R = len(movies_in_genre1_genre2.loc[movies_in_genre1_genre2['genre'] == genre1]['movieid'].unique())
    ...
    movies_in_genre1 = movies_in_genre1_genre2.loc[movies_in_genre1_genre2['genre'] == genre1]
    tags_movies_for_genre1 = movies_in_genre1.merge(df.tags_data, on='movieid', how='left').dropna()
    del tags_movies_for_genre1['userid']
    del tags_movies_for_genre1['epoch']
    del tags_movies_for_genre1['genre']
    movie_count_for_tags_genre1 = tags_movies_for_genre1.groupby(['tagid', 'movieid']).size().reset_index().groupby(
        ['tagid']).size().reset_index()
    movie_count_for_tags_genre1['r'] = movie_count_for_tags_genre1[0]
    ...
    movie_count_tags_for_genre1_genre2['m'] = movie_count_tags_for_genre1_genre2[0]
...
def p_distance(genre1, genre2):
    v1 = get_p_diff_1(genre1, genre2)
    v2 = get_p_diff_1(genre2, genre1)
...
def for_all_genres():
    ...
    final_data.to_csv('output/pdiff1.csv')